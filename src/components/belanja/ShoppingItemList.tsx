...
const ShoppingItemList = ({
  ...
  return <div className="mt-4">
      {items.length > 0 ? <ul className="space-y-2">
        ...
        </ul> : <div className="text-center py-4 text-muted-foreground">
      ...
      <div className="flex justify-end mt-4">
        <Button onClick={onSaveItems} className="bg-mibu-purple hover:bg-mibu-darkpurple" disabled={loading || items.length === 0}>
