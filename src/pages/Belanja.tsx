...
const Belanja = () => {
  ...
  return <MainLayout title="Belanja">
      <div className="space-y-6">
        {/* Budget Alert */}
        {isOverBudget && <BudgetAlert isOverBudget={isOverBudget} totalSpending={totalSpending} batasHarian={batasHarian} formatIDR={formatIDR} />}
        
        {/* Budget Summary */}
        <BudgetSummary gajiBulanan={gajiBulanan} belanjaWajib={belanjaWajib} batasHarian={batasHarian} budgetPercentageUsed={budgetPercentageUsed} formatIDR={formatIDR} />
        ...
        <section className="border border-gray-200 rounded-lg p-4">
          ...
          <Card className="border-2">
            <CardContent className="p-4 space-y-4">
              {!hasGaji ? <div className="p-6 text-center">
                  ...
                  {/* Shopping list */}
                  <ShoppingItemList items={shoppingItems} onRemoveItem={removeItem} onSaveItems={saveShoppingItems} totalSpending={totalSpending} isOverBudget={isOverBudget} formatIDR={formatIDR} loading={loading} />
                </>}
            </CardContent>
          </Card>
        </section>
